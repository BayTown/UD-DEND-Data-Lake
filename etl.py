...
def process_song_data(spark, input_data, output_data):
    ...
    song_data_inpath = os.path.join(input_data, 'song_data/*/*/*')
...
def process_log_data(spark, input_data, output_data):
    ...
    log_data = "{}{}".format(input_data, "log_data/*/*/*")
    ...
    time_table = df.select('start_time') \
                   ...
                   .withColumn('week', weekofyear('datetime').cast('Integer')) \
                   .withColumn('month', month('datetime').cast('Integer')) \
                   .withColumn('year', year('datetime').cast('Integer')) \
                   .withColumn('weekday', date_format('datetime', 'u').cast('Integer')) \
                   .distinct()
    ...
    songplays_table.write.parquet(songplays_table)
